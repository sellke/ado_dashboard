...
**Deliverable:** Configurable rolling-window cycle-time metrics for User Story, Spike, and Bug, shown at program and workstream levels.
...
- Error: unavailable lifecycle data shown without failing the dashboard.
...
4. Component/adapter tests verify formatted values and `N/A` behavior.
