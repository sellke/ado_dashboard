...
- [x] 🆕 Build **program velocity line chart** at x=0.3, y=3.0, w=6.2, h=3.7 — two series:
...
- [x] 🆕 Build **program bug burndown stacked bar chart** at x=6.8, y=3.0, w=6.2, h=3.7:
...
- [x] 🆕 Handle `programTrendSprints.length === 0` — skip both charts, render "No program trend data available" text at x=0.3, y=3.5, w=12.7, h=1.0
- [x] 🆕 Handle `sprint5Prediction === null` — velocity chart renders with only the `Completed Points` series + reference line
- [x] 🆕 Add unit tests: `programTrendSprints` populated → both charts render; empty `programTrendSprints` → placeholder, no throw; null `sprint5Prediction` → velocity chart has 1 series
...
- [x] 🆕 Program velocity line chart renders with Completed + Forecasted series (plus reference line)
- [x] 🆕 Program bug burndown stacked bar chart renders with Open (red) + Closed (green) series
- [x] 🆕 Empty `programTrendSprints` → placeholder text, both charts omitted, no crash
- [x] 🆕 Null `sprint5Prediction` → velocity chart renders with 1 series, no crash
