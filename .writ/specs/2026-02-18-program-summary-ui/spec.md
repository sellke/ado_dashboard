...
Identify most recent completed sprint. Perform manual spot check against ADO source data. Write automated validation tests. Document findings in `.writ/specs/2026-02-18-program-summary-ui/validation-report.md`.
